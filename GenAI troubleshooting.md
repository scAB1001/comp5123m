...
**GenAI Prompt:** > "I deployed Minikube successfully, but when I run 'sudo kubectl get pods', I get a connection refused error on localhost:8080. Why is it failing to connect?"
...
**GenAI Prompt:** > "My bash script runs 'minikube start' and 'systemctl start prometheus'. If the services are already running, the script hangs and freezes the terminal. Why is this happening and how can I prevent this?"
...
**GenAI Prompt:** > "I updated my Kubernetes YAML to combine two deployments into one. When I run 'kubectl apply -f manifest.yaml', the new combined pod starts, but the two old pods from yesterday are still running. Why didn't apply remove them?"
...
**GenAI Prompt:** > "My SSH connection to my Azure VM is suddenly timing out from my personal laptop, but it worked yesterday on the lab PC. I checked my Azure Network Security Group and there is a rule called 'MicrosoftDefenderForCloud-JITRule' blocking port 22. What is this rule and how is it affecting my connection?"
